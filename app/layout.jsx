...
export const metadata = {
  ...
  description: "Construire aujourd'hui, bâtir durablement demain. DGS SARL, votre partenaire de confiance en BTP, génie civil, immobilier et automobile à Conakry, Guinée.",
